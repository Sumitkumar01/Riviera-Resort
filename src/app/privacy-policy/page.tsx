...
export const metadata: Metadata = {
  title: "Privacy Policy | Riviera Resort Rishikesh",
  description: "Read the privacy policy of Riviera Resort Rishikesh. Understand how we handle your data to ensure your trust and safety.",
  keywords: ["Riviera Resort privacy policy",
    "Data handling Rishikesh resort",
    "Privacy policy for resorts",
    "User data protection Rishikesh resort",
    "Riviera Resort terms"],
  alternates: {
    canonical: "https://rivierastrokes.com/privacy-policy/",
    languages: {
      "en-US": "https://rivierastrokes.com/privacy-policy/",
    }
  },
  openGraph: {
    title: "Privacy Policy | Riviera Resort Rishikesh",
    description: "Read the privacy policy of Riviera Resort Rishikesh. Understand how we handle your data to ensure your trust and safety.",
    url: "https://rivierastrokes.com/privacy-policy/",
    siteName: "Riviera Resort Rishikesh",

    images: [
      {
        url: "https://rivierastrokes.com/privacy-policy/og-image.png",
        width: 1920,
        height: 1080,
      },
    ],
...
const DefinationList = [
  ...
  "Website refers to Riviera Resorts, accessible from https://wabisabiresorts.com/",
  ...
  return (
    <section>
      ...
      >
        ...
        {/* <div
          className="w-full h-full origin-center bg-black/10 -z-0  absolute top-0 left-0"
          style={{
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-12 flex flex-col gap-10">
        ...
        <div>
          ...
          <div className="mt-6">
            <h2 className="text-2xl font-semibold text-[#040404]">Personal Data</h2>
            <ul className="mt-2 flex flex-col gap-1 list-disc ml-6">
          ...
          <div className="mt-6">
            <h2 className="text-2xl font-semibold text-[#040404]">Usage Data</h2>
            <ul className="mt-2 flex flex-col gap-1 list-disc ml-6">
              {UsageDatalList.map((item, index) => (
                <li className="text-[#474747] text-md" key={index}>
                  {item}
                </li>
              ))}
          ...
          <div className="mt-6">
            ...
            <ul className="mt-2 flex flex-col gap-1 list-disc ml-6">
              {PersonalDataLis2.map((item, index) => (
                <li className="text-[#474747] text-md" key={index}>
                  {item}
                </li>
              ))}
        ...
        <div>
          ...
          <div className="mt-6">
            ...
            <ul className="mt-2 flex flex-col gap-1 list-disc ml-6">
              <li className="text-[#474747] text-md">
                By email: info@rivieraresortrishikesh.com
              </li>
            </ul>
          </div>
        </div>
